...
conn = oc.connect(user="RM98581", password="261204", dsn="oracle.fiap.com.br:1521/ORCL")
print(conn.version)
...
def dados_pessoais():
    while True:
        ...
        if ano_nascimento <= 2004:
            ...
            break
        # VERIFICANDO SE O CPF TEM FORMATO VALIDO
        TAM_CPF = 14
        ...
        if(flag):
            ...
            print("O CPF informado nao tem um formato valido")
        sexo = input('Sexo (M/F): ')
